...
namespace Editor
{
    public partial class frmProject : Form
    {
        ...
        private void frmProject_Load(object sender, EventArgs e)
        {
          try
          {
             ...
             //----------------------------------
              ...
              MySqlCommand cmd1 = new MySqlCommand("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA = 'lim_db'", Common.conLim);
              ...
              Adp = new MySqlDataAdapter("SELECT * FROM tblEngine", Common.con);
              ds = new DataSet();
              Adp.Fill(ds);
              ...
              Common.Open_Connection("gen_db", "con");
              Adp = new MySqlDataAdapter("Select * from tblProject", Common.con);
              ds = new DataSet();
              Adp.Fill(ds);
              PrjGV.DataSource = ds.Tables[0];
              PrjGV.Columns[0].Width = 200;
              PrjGV.Columns[1].Width = 200;
              PrjGV.Columns[2].Width = 200;
              PrjGV.Columns[3].Width = 200;
              PrjGV.Columns[4].Width = 150;
              PrjGV.Columns[5].Width = 150;
              PrjGV.Columns[6].Width = 80;
              PrjGV.Columns[7].Width = 80;
              PrjGV.Columns[8].Width = 80;
              PrjGV.Columns[9].Width = 80;
              PrjGV.Columns[10].Width = 80;
              PrjGV.Columns[11].Width = 80;
              PrjGV.Columns[12].Width = 80;
              PrjGV.Columns[13].Width = 80;
              PrjGV.Columns[14].Width = 80;
              PrjGV.Columns[15].Width = 80;
              foreach (DataGridViewColumn colm in PrjGV.Columns)
              {
                  //PrjGV.Columns[colm].Width = 100;
                  colm.SortMode = DataGridViewColumnSortMode.NotSortable;
              }
        ...
        private void Load_InCell()
        {
            ...
            {
                Common.Create_OnLog(ex.Message + " :  Load In Cell....", "Alart");  
        ...
        private void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                return;
                //Common.Create_OnLog(ex.Message + " :  File Save....", "Alart");  
