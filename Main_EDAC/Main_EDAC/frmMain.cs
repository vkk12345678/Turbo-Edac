       ...
       private void tmrWrite_Tick(object sender, EventArgs e)
        {
            ...
            {                  
                ...
                if ((flg_AnaOut == true) && (Global.flg_Smt_Changeover == true)) Fun_AnalogOut_SmoothChangeover();
                if ((flg_AnaOut == true) && (Global.flg_Std_Changeover == true)) Fun_AnalogOut_StandardChangeover();
                ...
                {
                    Global.S_pt1 = (int)(Global.AnaOut1 * 500);
                    ...
                    //Global.GenData[7] = Global.RandomNumberBetween((X + 0.005), (X - 0.002)).ToString("0.000"); // (Convert.ToDouble(((X + 0.2) - (X + 0.2)) + 0.1) * RandomNumber(-1, 4) + (X - 0.5)).ToString("#00.0"); //RandomNumber2(X - 0.05, X + 0.5).ToString("#00.0");
                    //X = Convert.ToDouble(textBox2.Text);
                    //Global.GenData[10] = Global.RandomNumberBetween((X + 0.2), (X - 0.1)).ToString("000.0");  //(Convert.ToDouble(((X + 0.25) - (X + 0.1)) + 0.1) * RandomNumber(-1, 4) + (X - 0.1)).ToString("#00.0"); //RandomNumber2(X - 0.05, X + 0.5).ToString("#00.0");
                    //X = Convert.ToDouble(textBox3.Text);
                    //Global.GenData[13] = Global.RandomNumberBetween((X + 0.2), (X - 0.1)).ToString("000.0");  //(Convert.ToDouble(((X + 0.25) - (X + 2)) + 2) * RandomNumber(-1, 4) + (X - 2)).ToString("#00.0"); //RandomNumber2(X - 0.05, X + 0.5).ToString("#00.0");
                    //X = Convert.ToDouble(textBox7.Text);
                    //Global.GenData[22] = Global.RandomNumberBetween((X + 0.2), (X - 0.1)).ToString("000.0");  //(Convert.ToDouble(((X + 0.25) - (X + 2)) + 2) * RandomNumber(-1, 4) + (X - 2)).ToString("#00.0"); //RandomNumber2(X - 0.05, X + 0.5).ToString("#00.0");
        ...
        public void Load_ProgStep()
        {
            try
            {
                ...
                if (GridSeq[0, Global.StpN].Value != null)
                {
                    ...
                    {
                        Global.AnaOut2 = Global.LastAna2 * 10;
                        Global.LastAna2 = Global.LastAna2 * 10;
            ...
            try
            {
                ...
                if (Global.varRPM <= Global.S_Rpm)
                {
                    ...
                    if (Global.varRPM >= Global.S_Rpm) //Convert.ToInt16(Global.Prj[12]))
                    {
                        ...
                        Global.Create_OnLog(Global.Prj[3], "Normal");
                        //frmPar.btnStart.Enabled = true;
                        //frmPar.btnStop.Enabled = true;
                    }
                    else
        ...
        private void tmrAnaOut_Tick(object sender, EventArgs e)
        {
            if (flg_M_Ramp == true)
            {
                ...
                else
                {
                    ...
                    if (Global.flg_Semi_Auto == true) clsFun.MODE_TO_MODE_Smooth();
                }
            }
            else
            {
