...
--
-- Table structure for table `gentemp`
--

DROP TABLE IF EXISTS `gentemp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `gentemp` (
  ...
  `PCal26` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gentemp`
--

LOCK TABLES `gentemp` WRITE;
/*!40000 ALTER TABLE `gentemp` DISABLE KEYS */;
/*!40000 ALTER TABLE `gentemp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-03-18 16:01:40
