...
INSERT INTO `tblengine` VALUES ('Eng_DYNALEC','Diesel','110.000','4','127.000','6.03538925','0.835','687678','**','***','***','55','Air Cooled','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','TurboEnergy','45566'),('Eng_S327_NA','Diesel','095.000','03','127.000','2.70096','0.835','687678','18.5','SAE 15W40','***','55','water cooled','Regular','inline','BOSCH','E 040 301 500','11°BTDC','***','B335','VCO','391 943','***','***','***','***','***','***','***','***','***',NULL),('eng_trail','Diesel','083.000','03','092.000','1.493521422','0.835','687678','**','***','***','55','Air Cooled','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','TurboEnergy','45566'),('Eng_TSJ436','Diesel','095.000','04','127.000','3.60128185','0.835','687678','**','***','***','55','Air Cooled','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','TurboEnergy',NULL),('eng_tuv_u301','Diesel','083.000','03','092.000','1.493521422','0.835','687678','**','***','***','55','Air Cooled','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','***','TurboEnergy','45566');
